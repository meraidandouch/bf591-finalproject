...
This RShiny app attempts to summarize RNASeq bioinformatics studies and processes into multiple tabs. This app only works specifically for data generated by Hérault et al., 2019 study. I have uploaded the data you can use in the rshiny app to generate results, try it out! Please note: all data belongs to Hérault et al., 2019 study! 
...
- Raw read count data is too large for the rshiny app to process, I need to figure out why that is 
